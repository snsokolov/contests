...
class Strings:
    ...
    def splitcheck(self, a, b):
        ...
        if la % 2 == 1:
            for i in range(la):
                if self.stra[a[0]+i] != self.strb[b[0]+i]:
                    return 0
            return 1

        if la == 2:
            a0, a1 = self.stra[a[0]], self.stra[a[1]-1]
            b0, b1 = self.strb[b[0]], self.strb[b[1]-1]
            return (a0 == b0 and a1 == b1) or (a0 == b1 and a1 == b0)

        if la == 4:
            a0, a1, a2, a3 = list(self.stra[a[0]:a[1]])
            b0, b1, b2, b3 = list(self.strb[b[0]:b[1]])

            answ = ((((a0 == b0 and a1 == b1) or (a0 == b1 and a1 == b0)) and
                     ((a2 == b2 and a3 == b3) or (a2 == b3 and a3 == b2))) or
                    (((a0 == b2 and a1 == b3) or (a0 == b3 and a1 == b2)) and
                     ((a2 == b0 and a3 == b1) or (a2 == b1 and a3 == b0))))
        ...
        a1, a2 = (mida, a[1]), (a[0], mida)
        b1, b2 = (midb, b[1]), (b[0], midb)
...
class unitTests(unittest.TestCase):
    ...
    def test_Strings_class__basic_functions(self):
        ...
        self.assertEqual(d.splitcheck((0, 1), (0, 1)), 1)
        self.assertEqual(d.splitcheck((3, 4), (0, 2)), 0)
        self.assertEqual(d.splitcheck((3, 6), (0, 3)), 0)
        self.assertEqual(d.splitcheck((3, 5), (1, 3)), 1)
        d.stra = "abcdefgh"
        d.strb = "efhgdcba"
        self.assertEqual(d.splitcheck((0, 8), (0, 8)), 1)
    ...
    def test_time_limit_test(self):
        ...
        numnums = [chars[random.randint(0, 25)] for i in range(imax)]
        test = "".join(numnums) + "\n"
        numnums = [chars[random.randint(0, 25)] for i in range(imax)]
        test += "".join(numnums) + "\n"
